...
import com.internetpolice.app.navigations.openOverlaySettings
...
import com.internetpolice.core.designsystem.theme.subHeading1SpanStyle
...
fun OverlayPermissionScreen(
    ...
    Column(
        ...
        ConstraintLayout {
            ...
            Image(
                painter = painterResource(id = drawable.ic_blue_cross),
                contentDescription = "",
                modifier = Modifier
                    .size(40.dp)
        ...
        Image(
            painter = painterResource(id = drawable.ic_overlay_master_permission),
